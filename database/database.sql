...
INSERT INTO medicamentos (id, nombre, codigo, descripcion, stock, precio) VALUES
(1, 'Paracetamol 500mg', 'MED-PAR500', 'Analgésico y antipirético común para aliviar dolores de cabeza y fiebre.', 150, 0.25),
(2, 'Ibuprofeno 400mg', 'MED-IBU400', 'Antiinflamatorio no esteroideo para dolores musculares e inflamaciones.', 100, 0.45),
(3, 'Amoxicilina 500mg', 'MED-AMO500', 'Antibiótico de amplio espectro para infecciones bacterianas respiratorias o de garganta.', 80, 1.20),
(4, 'Omeprazol 20mg', 'MED-OME20', 'Protector gástrico indicado para acidez estomacal, gastritis y reflujo.', 200, 0.35),
(5, 'Loratadina 10mg', 'MED-LOR10', 'Antihistamínico para el alivio de síntomas de alergia como rinitis y estornudos.', 120, 0.50);