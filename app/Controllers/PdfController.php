...
class PdfController {
    ...
    private function descargarPDF($html, $historial) {
        // En lugar de enviar código HTML crudo etiquetado como PDF (lo cual corrompe el archivo),
        // servimos una vista HTML limpia de impresión que ejecuta automáticamente la utilidad
        // nativa de guardado a PDF e impresión del navegador web.
        header('Content-Type: text/html; charset=UTF-8');
        
        // Agregamos un script de ejecución inmediata para abrir el cuadro de impresión
