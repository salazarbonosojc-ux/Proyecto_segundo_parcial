...
<body>
    ...
    } elseif (preg_match('/especialidad/i', $url_navegador)) {
        $pageTitle = 'Especialidades Médicas';
    } elseif (preg_match('/diagnostico/i', $url_navegador)) {
        $pageTitle = 'Diagnósticos Clínicos';
    } elseif (preg_match('/medicamento/i', $url_navegador)) {
        $pageTitle = 'Catálogo de Medicamentos';
    } elseif (preg_match('/usuario/i', $url_navegador)) {
            ...
            <div class="sidebar-top-group">
                ...
                <nav class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="index.php?url=diagnosticos" class="<?= preg_match('/diagnostico/i', $url_navegador) ? 'active' : ''; ?>">Diagnósticos</a>
                        </li>
                        <li>
                            <a href="index.php?url=especialidades" class="<?= preg_match('/especialidad/i', $url_navegador) ? 'active' : ''; ?>">Especialidades</a>
                        </li>
                        <li>
                            <a href="index.php?url=medicamentos" class="<?= preg_match('/medicamento/i', $url_navegador) ? 'active' : ''; ?>">Medicamentos</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="index.php?url=usuarios" class="<?= preg_match('/usuario/i', $url_navegador) ? 'active' : ''; ?>">Usuarios</a>
                        </li>
                    </ul>
                </nav>
            </div>
